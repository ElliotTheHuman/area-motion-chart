...
// This is what's known as an "Immediately Invoked Function Expression"
// We're passing in Highcharts (as var H, and thus referring to Highcharts as H)
(function (H) {
    ...
    function Motion(chart) {
        ...
        this.playControls = H.createElement('div', {
            id: 'play-controls',
            style: 'text-align: center; width: 100%; padding: 5px 0 1em 0;'
        ...
        this.playPauseBtn = H.createElement('button', {
            ...
            title: 'play',
            style: 'width: 30px; height: 30px; text-align: center; font-size: 15px; outline: none; cursor: pointer;',
        ...
        this.playOutput = H.createElement('label', {
            ...
            style: 'font-family:"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif; font-size: 20px;',
        }, null, this.playControls, null);
